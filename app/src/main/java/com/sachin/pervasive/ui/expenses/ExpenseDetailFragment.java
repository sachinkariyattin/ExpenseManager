...
import com.sachin.pervasive.ui.BaseFragment;
import com.sachin.pervasive.utils.DateUtils;
...
public class ExpenseDetailFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static final String DOWNLOAD_URI = "https://firebasestorage.googleapis.com/v0/b/expensetracker-cceef.appspot.com/o/Photos%2F";
    public static final String URI2 = "%2Freceipt.jpg?alt=media&token=a3608a43-4fe1-43fc-8e4a-b30596e84576";
    ...
    private void loadData() {
        ...
        String x = DOWNLOAD_URI + Uid + URI2;
        Glide.with(getActivity().getApplicationContext()).load(x).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).into(imageView);
    }
